...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($errors)) {
        $sql = "UPDATE products SET product_name = ?, description = ?, price = ?, quantity = ?, category = ?, image_url = ?, status = ? WHERE id = ?";
    ...
    <div class="container">
        ...
        <?php if ($success): ?>
            <div class="success-message">
                ✓ Product updated successfully! <a href="view_products.php" style="color: #155724; text-decoration: underline;">Back to products</a>
            </div>
        <?php endif; ?>
        ...
        <form method="POST" action="" novalidate>
            ...
            <div class="button-group">
                ...
                <a href="view_products.php" class="btn-cancel" style="display: flex; align-items: center; justify-content: center; text-decoration: none; background: #6c757d;">Cancel</a>
            </div>
        </form>
    </div>
</body>
